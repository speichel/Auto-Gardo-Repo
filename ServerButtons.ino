...
char const string_10[] PROGMEM = "<meta http-equiv=refresh content=30 > "; //for auto refresh

PGM_P const string_table[] PROGMEM = // change "string_table" name to suit    // change "string_table" name to suit
{  
  string_0,
  string_1,
  string_2,
      ...
      if (client.available()) {
         ...
         */
          ...
          if(digitalRead(4)==HIGH){
           ...
           servoLeft.writeMicroseconds(800);        // Right wheel clockwise
           delay(1000); 
          }else{
          ...
          if(digitalRead(5)== HIGH){
           ...
           servoLeft.writeMicroseconds(2200);        // Right wheel clockwise
           delay(1000); 
          }else{
